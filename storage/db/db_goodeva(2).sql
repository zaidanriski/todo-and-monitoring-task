...
--
-- Host: localhost:3306
-- Generation Time: Feb 02, 2020 at 11:44 PM
...
(11, '2020_02_02_224540_create_setting_tanggals_table', 6);
...
(1, 1, '2020-01-30', 1, '<p>tes reminder 6</p>', '2020-01-31 09:00:00', '2020-01-29 22:00:01', '2020-02-02 15:19:20'),
(3, 1, '2020-01-31', 0, '<p>tes reminder 2</p>', '2020-01-31 03:17:00', '2020-01-30 19:34:11', '2020-01-30 20:15:52'),
(4, 1, '2020-02-02', 0, '<p>tes aja</p>', '2020-02-02 05:00:00', '2020-02-02 15:13:13', '2020-02-02 15:13:13'),
(5, 1, '2020-02-02', 0, '<p>qwerty</p>', '2020-02-02 05:00:00', '2020-02-02 15:19:36', '2020-02-02 15:19:36');
...
--
-- Table structure for table `setting_tanggals`
--

CREATE TABLE `setting_tanggals` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `setting_tanggals`
--

INSERT INTO `setting_tanggals` (`id`, `tahun`, `bulan`, `tanggal`, `description`, `created_at`, `updated_at`) VALUES
(1, 2020, 4, 26, NULL, '2020-02-02 16:23:56', '2020-02-02 16:23:56'),
(2, 2020, 4, 6, NULL, '2020-02-02 16:23:56', '2020-02-02 16:23:56'),
(3, 2020, 4, 24, NULL, '2020-02-02 16:23:56', '2020-02-02 16:23:56'),
(4, 2020, 1, 26, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(5, 2020, 1, 28, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(6, 2020, 1, 29, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(7, 2020, 1, 4, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(8, 2020, 1, 5, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(9, 2020, 1, 11, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(10, 2020, 1, 12, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(11, 2020, 1, 18, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(12, 2020, 1, 19, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37'),
(13, 2020, 1, 25, NULL, '2020-02-02 16:39:37', '2020-02-02 16:39:37');
...
CREATE TABLE `tasks` (
  ...
  `measer` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(30, 1, '2020-01-31', 'Other Task', '08:15', '08:15', 100, 4, 0, 1, NULL, 0, NULL, NULL, '2020-01-30 19:32:56', '2020-02-02 07:24:14'),
...
(33, 1, '2020-01-31', 'Other Task', '08:15', '08:15', 100, 4, 0, 1, NULL, 0, NULL, NULL, '2020-01-30 19:32:56', '2020-02-02 07:24:14'),
(35, 1, '2020-01-31', 'tes demo 2 admin', '12:00', '15:00', 1, 4, 0, 1, NULL, 0, NULL, NULL, '2020-01-31 04:09:03', '2020-02-02 07:24:14'),
(36, 1, '2020-02-02', 'Other Task', '08:15', '08:15', 100, 0, 0, 0, NULL, 0, NULL, NULL, '2020-02-02 07:24:13', '2020-02-02 07:24:13'),
(37, 1, '2020-02-02', 'Other Task', '08:15', '08:15', 100, 0, 0, 0, NULL, 0, NULL, NULL, '2020-02-02 07:24:14', '2020-02-02 07:24:14'),
(39, 1, '2020-02-02', 'tes tambah', '12:00', '12:00', 1, 0, 0, 0, NULL, 0, NULL, NULL, '2020-02-02 08:51:22', '2020-02-02 08:51:22'),
(40, 1, '2020-02-02', 'Other Task', '00:00', '00:00', 100, 0, 0, 0, 1, 0, '<p>tes problem</p>', '<p>problwm 2</p>', '2020-02-02 09:13:38', '2020-02-02 09:13:38'),
(41, 8, '2020-01-27', 'desain web pmp', '08:00', '12:00', 1, 4, 0, 1, NULL, 0, NULL, NULL, '2020-02-02 15:33:43', '2020-02-02 15:33:43'),
(42, 8, '2020-01-27', 'chart dashboard web pmp', '08:15', '12:00', 101, 4, 0, 1, NULL, 0, NULL, NULL, '2020-02-02 15:33:43', '2020-02-02 15:33:43'),
(43, 8, '2020-02-02', 'desain web pmp', '08:15', '08:15', 1, 0, 0, 0, NULL, 0, NULL, NULL, '2020-02-02 15:33:43', '2020-02-02 15:33:43'),
(44, 8, '2020-02-02', 'chart dashboard web pmp', '08:15', '08:15', 101, 0, 0, 0, NULL, 0, NULL, NULL, '2020-02-02 15:33:43', '2020-02-02 15:33:43');
...
CREATE TABLE `users` (
  ...
  `divisi` int(11) DEFAULT NULL COMMENT '1=cit 2=cbd',
...
(1, 'zaidan riski', 'zdnrsk@gmail.com', 'zaidanriski', 1, NULL, '$2y$10$fajVnRVs7yAD2Y28Lc6c5O1DrqE6yvBLuAzPkpdhpe.sEmBG75Xbe', 1, 'Staff IT', 'tes', 'profile-1-4.jpg', NULL, NULL, '2020-01-21 00:49:41', '2020-02-02 10:17:32'),
...
(7, 'zakian', 'zakian@gmail.com', NULL, 1, NULL, '$2y$10$K4I8upZytuZCzrakISFL4e9MupInSBKAHbR/hJUT2TIYLpwEEfT.K', 1, NULL, NULL, NULL, NULL, NULL, '2020-02-02 07:46:44', '2020-02-02 07:46:44'),
(8, 'Rizky Saputra', 'srizki4455@gmail.com', 'rizki445', 1, NULL, '$2y$10$l1IbnjqgjQY9NTaKp31tw.ynZ0OfHcdqI3EQ4gXzo/i5j/ld.Hkxm', 2, 'Programmer', NULL, NULL, NULL, NULL, '2020-02-02 15:32:33', '2020-02-02 15:35:49');
...
--
-- Indexes for table `setting_tanggals`
--
ALTER TABLE `setting_tanggals`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `setting_tanggals`
--
ALTER TABLE `setting_tanggals`
