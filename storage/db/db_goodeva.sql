...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 22, 2020 at 11:20 AM
...
CREATE TABLE `tasks` (
  ...
  `counter_measer` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tasks` (`id`, `id_user`, `tanggal`, `task`, `jam_mulai`, `jam_selesai`, `status`, `status_check`, `problem`, `counter_measer`, `created_at`, `updated_at`) VALUES
(1, 1, '2020-01-22', 'membuat layout', '08:15', '12:00', 1, 0, NULL, NULL, '2020-01-22 02:19:21', '2020-01-22 02:19:21'),
(2, 1, '2020-01-22', 'membuat crud asset', '13:00', '17:00', 1, 0, NULL, NULL, '2020-01-22 02:19:21', '2020-01-22 02:19:21');
